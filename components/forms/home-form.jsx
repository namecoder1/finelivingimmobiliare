...
const ContactPageForm = () => {
	...
	return (
		<form name="Pagina Contatto" onSubmit={handleFormSubmit} netlify className="mt-10 flex flex-col items-center xl:mx-5 gap-10">
			<input type="hidden" name="form-name" value="Pagina Contatto" />
