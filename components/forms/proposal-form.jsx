...
const ProposalForm = () => {
	...
	return (
		<form name="Pagina Proponi" onSubmit={handleFormSubmit} netlify className="mt-10 flex flex-col items-center xl:mx-5 gap-10">
				<input type="hidden" name="form-name" value="Pagina Proponi" />
				...
				<div className="flex flex-col lg:flex-row items-center justify-between w-full gap-10">
					<Input required type='text' name='Totale Mq' placeholder='*Totale Mq' />
				...
				{status === 'ok' && (
							<div className="alert alert-success">
									<MdOutlineDoneOutline  /> Submitted!
							</div>
					)}
					{status === 'error' && (
